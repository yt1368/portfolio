...
//生成導覽列。 下方透過呼叫getCartNum()，顯示目前購物車中的商品數量
export function presentNav()        
{
    ...
    `
        <ul class="phone_top_nav">
            ...
            <li class="user_search_part">
                <p class="user_search_p">
                    <input type="text" class="phone_user_search" name="user_search">
                    <img class="phone_user_search_img" src="images/search.png" alt="搜尋圖片">
                </p>
            </li>
